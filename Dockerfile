...
ARG BUILDER=public.ecr.aws/eks-distro-build-tooling/golang:1.26.6
...
FROM --platform=$TARGETPLATFORM public.ecr.aws/eks-distro-build-tooling/go-runner:v0.18.0-go-1.26-latest.al23 as go-runner
